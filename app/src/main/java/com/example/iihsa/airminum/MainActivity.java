...
import com.example.iihsa.airminum.fragment.Reminder;
import com.example.iihsa.airminum.fragment.Profil;
import com.example.iihsa.airminum.fragment.Rekapan;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_rekapan) {
            fragment = new Reminder();
            callFragment(fragment);

        } else if (id == R.id.nav_pengaturan) {
            fragment = new Rekapan();
            callFragment(fragment);
        }
